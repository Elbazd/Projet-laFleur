...
<form name="formAjout" action="" method="post" onSubmit="return valider()">
  <fieldset>
    <legend>Entrez les données sur l'utilisateur a rechercher </legend>
    <label>Entrez le matricule </label> <input type="text" placeholder="Entrer l'identifiant …"name="mat" size="10" /><br />
